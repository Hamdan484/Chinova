          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-gray-900 sm:text-xl/8">
                We are dedicated to providing you with the best coffee
                experience possible. Our team of expert baristas carefully
                selects and roasts our beans to ensure that every cup of coffee
                we serve is of the highest quality. Whether you prefer a classic
                espresso or a creamy latte, we have something for everyone. Come
                visit us and discover your new favorite coffee today!
              </p>
