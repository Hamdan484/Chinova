...
export default function Example() {
  return (
    <div className="isolate bg-cyan-50 px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg/8 text-gray-600">We'd love to hear from you. Reach out anytime and we'll get back to you.</p>
      </div>
